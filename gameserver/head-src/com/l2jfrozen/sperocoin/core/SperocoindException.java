 ...
 *  @author Nicola Atzei
 */
public class SperocoindException extends Error {

	private static final long serialVersionUID = 4505365298463956527L;

	private RPCErrorCode code;

	public SperocoindException(String message, RPCErrorCode code) {
		super(message);
		this.code = code;
	}
	...
	public String toString() {
		return "SperocoindException [code=" + code + ", message=" + getMessage() + "]";
	}
