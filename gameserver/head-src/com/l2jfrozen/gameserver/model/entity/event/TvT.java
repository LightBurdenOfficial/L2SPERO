...
public class TvT implements EventTask
{
	...
	public static void showEventHtml(final L2PcInstance eventPlayer, final String objectId)
	{
		try
		{
			...
			final TextBuilder replyMSG = new TextBuilder("<html><title>TvT</title><body>");
					...
					else
					{
						...
						if (Config.TVT_EVEN_TEAMS.equals("NO") || Config.TVT_EVEN_TEAMS.equals("BALANCE"))
						{
							...
							for (final String team : _teams)
							{
								...
								replyMSG.append("<center><td width=\"60\"><button value=\"Join\" action=\"bypass -h npc_" + objectId + "_tvt_player_join " + team + "\" width=140 height=21 back=\"L2UI_ch3.msnbutton_over\" fore=\"L2UI_ch3.msnbutton\"></center></td></tr>");
							}
